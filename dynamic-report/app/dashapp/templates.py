...
def add_topbar(title):
    content = html.Header(
        ...
        children=[
            html.Div(
                className="header__logos col-lg-9",
                children=[
                    html.Div(
                        className="header__logo",
                        children=[
                            html.Img(
                                className="logo-carol",
            ...
            html.Div(
                id="header__title col-lg-3",
                className="",
                children=[
                    html.H1(className="header__label", children=title),
                    html.Div(
                        className="class-rightbutton",
                        children=[
                            html.A(
                                "Logout", href="/logout", className="logout_btn"
                            )
                        ],
                    ),
                ],
...
def add_card(title, value):
    template = html.Div(
        ...
        children=[
            ...
            html.Div(className="card-value", children=[str(value)]),
        ],
    )
