                    ...
                    children=[
                        html.Div(
                            ...
                            children=[
                                ...
                                html.Div(
                                    className="col-lg-12 combo-container",
                                    children=[
                                        dcc.Dropdown(
                                            id="grafico",
                                            options=[
...
def get_purchases_chart(title, id, x, y):
    return html.Div(
        ...
        children=[
            ...
            dcc.Graph(
                id=id,
                figure={"data": [{"x": x, "y": y, "type": "bar", "name": "Barras"}]},
            ),
        ],
    )
        ...
        dropdown_values.append(
            html.Div(
                ...
                children=[
                    html.Div(
                        className="col-lg-6",
                        children=[add_card("Titulo Card 1", str(card_value1))],
                    ),
                    html.Div(
                        className="col-lg-6",
                        children=[add_card("Titulo Card 2", str(card_value2) + "%")],
                    ),
                ],
            )
        )
